...
function(determine_target_architecture FLAG)
  ...
  message(WARNING "\
determine_target_architecture() should no longer be used:
architecture should be chosen before running cmake, and reflected in CMAKE_PREFIX_PATH/CMAKE_INSTALL_PREFIX
")

  if (MSVC)
    if("${MSVC_C_ARCHITECTURE_ID}" STREQUAL "X86")
      set(ARCH "i686")    # TODO: better use "x86"?
    elseif("${MSVC_C_ARCHITECTURE_ID}" STREQUAL "x64")
      set(ARCH "x86_64")  # TODO: better use "x64"?
